...
\toprule
Detector & Input & Temporal core & Params &
Initialization/artifact provenance & $\tau$ \\
\midrule
...
& LSTM(128)
& 1,308,401
& ImageNet; warm-up + partial fine-tune
& .82 \\
...
& LSTM(128)
& 1,868,441
& scratch; full end-to-end, best epoch 16/28
& .12 \\
...
& LSTM(128)
& 3,369,255
& scratch; full end-to-end, best epoch 27/39
& .90 \\
...
& LSTM(128)
& 4,779,300
& ImageNet; best warm-up epoch 47
& .90 \\
...
& GRU
& 17,621,410
& external reference; ONNX export
& .50 \\
...
\toprule
Model & Clean F1 & Noise $\Delta$ & Codec $\Delta$ &
Replay $\Delta$ & Mean (9) \\
\midrule
...
\centering
\scriptsize
\caption{Measured float32 batch-one desktop-CPU efficiency
(10 warm-ups, 50 runs).}
